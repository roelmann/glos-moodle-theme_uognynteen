...
$page = new admin_settingpage('theme_uognynteen_presets', get_string('presets_settings', 'theme_uognynteen'));

// Preset.
$name = 'theme_uognynteen/preset';
$title = get_string('preset', 'theme_uognynteen');
$description = get_string('preset_desc', 'theme_uognynteen');
$presetchoices = array();
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_uognynteen', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_uognynteen/presetfiles';
$title = get_string('presetfiles', 'theme_uognynteen');
$description = get_string('presetfiles_desc', 'theme_uognynteen');
