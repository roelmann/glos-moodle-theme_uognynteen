 ...
 * @return bool
 */
function theme_uognynteen_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('uognynteen');
    }
     ...
     */
function theme_uognynteen_get_setting($setting, $format = false) {
    global $CFG;
