...
$THEME->layouts = [
    ...
    'mydashboard' => array(
        'file' => 'mydash.php',
        'regions' => array('side-pre', 'side-top', 'side-post', 'side-slidertwo', 'side-sliderthree', 'side-sliderfour'),
        'defaultregion' => 'side-pre',
...
$THEME->scss = function($theme) {
    return theme_uognynteen_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_uognynteen_css_tree_post_processor';
$THEME->prescsscallback = 'theme_uognynteen_get_pre_scss';
$THEME->extrascsscallback = 'theme_uognynteen_get_extra_scss';
